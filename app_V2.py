...
CHROMA_PATH = "chroma_db_final_v3"
    ...
    try:
        ...
        if isinstance(response, dict) and "models" in response:
            ...
            for m in response.models:
                ...
                if name:
                    models.append(name)
        return models if models else ["llama3.2:3b", "qwen2.5:3b", "gemma2:2b", "qwen2.5:7b", "mistral:7b"]
    except Exception:
        return ["llama3.2:3b", "qwen2.5:3b", "gemma2:2b", "qwen2.5:7b", "mistral:7b"]
        ...
        for para in paragraphs:
            ...
            for sentence in sentences:
                ...
                if len(current_chunk) + len(sentence) > max_length and current_chunk:
                    ...
                    # Et on commence un nouveau chunk avec la phrase en cours
        ...
        if not existing or len(existing["ids"]) == 0:
            ...
            if document_chunks:
                ...
                for idx, chunk in enumerate(document_chunks):
                    ...
                    embeddings.append(embedding_model.encode(enriched_text).tolist())
                    metadatas.append({
...
"""
            with st.chat_message("assistant"):
                ...
                try:
                    ...
                    # On affiche l'expander de manière SYSTÉMATIQUE
                    with st.expander(" Ressources consultées"):
                        for i_src, src in enumerate(unique_sources.values()):
                            cols = st.columns([3, 1, 1])
                            with cols[0]:
